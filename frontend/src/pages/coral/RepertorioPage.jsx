    ...
    setTimeout(() => {
      setRepertorio([
        ...
        },
        {
          ...
          observacoes: 'Peça sacra tradicional'
        },
        {
          id: 4,
          titulo: 'Kyrie',
          ...
          video: '',
          observacoes: 'Música renascentista'
        },
        {
          id: 5,
          titulo: 'Gloria in Excelsis',
          compositor: 'Vivaldi',
          arranjo: 'Pedro Santos',
          nivel: 'Intermediário',
          naipe: 'Baixo',
          ...
          observacoes: 'Peça barroca festiva'
        }
      ]);
      setLoading(false);
    }, 1000);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <Link to="/coral" className="mr-4 text-gray-600 hover:text-blue-600 transition-colors">
                <ArrowLeft className="h-6 w-6" />
              </Link>
              <Music className="h-8 w-8 text-blue-600 mr-3" />
              <h1 className="text-2xl font-bold text-gray-900">Repertório do Coral</h1>
            </div>
          </div>
        </div>
      </header>
